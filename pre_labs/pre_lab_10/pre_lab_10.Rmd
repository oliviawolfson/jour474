...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answer it's all Zip codes**
...
**Task** Run the following code. Describe the output in the space below. **Answer It's a map of Maryland by each zip code**
...
**Task** Run the following code. Describe the output in the space below. **Answer It is a dataframe of zip codes**
...
**Task** Run the following code. Describe the output in the space below. **Answer this is filtered by counties**
...
library(janitor)
library(tidycensus)
census_api_key("b77479320edd25081dec20f40b8cd6da57f76f4a")
```
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer Charles county has the highest foreclosure reate**
