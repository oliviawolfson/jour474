...
**Task** Run the following code to add a month column to our dataframe using lubridate and count the number of calls for each month. In the space below, explain what each step of the code below is doing in English. Note the "label=TRUE" part in the mutate statement. **Answer It's making the month a label, then it is grouping the data by the total calls for that month**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I am seeing a bar chart based off of total calls for each month**
...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer Now the bars are going horizontally instead of vertically**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I am seeing total calls by date**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I am seeing a line chart based off of the total calls by day for presumably a year.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer I am seeing the same line chart but it is instead trying to go by week which is smushing everything together**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer Now I am seeing each week clear because the x axis labels are at an angle.**
