...
**Task** Run the following code and describe the dataframe it outputs. **Answer each state in alphabetical order with how much they spent on education per person, gdp growth, population change, and who won the popular vote in 2020.**
...
**Task** Run the following code. Describe the plot. What pattern do you see? **Answer A scatter plot comapring gdp growth to population change**
...
**Task** Run the following code. Describe the table output in terms of the strength of relationships between the variables. What do you see? **Answer Correlation between education, gdp, and population change are generally negative**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer Negative correlations again and the confidence interval**
...
**Task** Run the following code. Describe the model output. What do you see? **Answer A negative correlation between pop growth and gdp growth**
...
**Task** Run the following code. Describe the table. What do you see? **Answer The averages of each category**
