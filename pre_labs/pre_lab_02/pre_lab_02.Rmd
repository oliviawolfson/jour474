...
**Answer This is important for future coding so we just manipulate the classes that we want to see.**
...
**Answer: Now the date is a data column and not a character column. It also is written by year-month-day and is not separated by slashes.**
...
**Answer The month column is no longer just the month but the first of every month for the year. It makes each page just whatever that year was and then organizes it from there.**
...
**Answer The code is naming a new general_22 code to mutate the rest of the data in it. It then is taking all of the candidates and write in votes and adding them together to create a new total votes variable. Then it is finding the percent of Moore votes based off of the new variable.**
...
**Answer It is now rounded to the nearest hundredth percent and going in descending order because we multiplied it by 100 and coded the arrangement to be different**
...
**Answer This is a useful answer to see where Moore didn't fair well in the election. It can be used to then look at the demographics of the people that do support him in comparison to not.**
...
**Answer ChatGPT- "what's a tidy verse function that makes everything lower case" and got str_to_lower.**

**ChatGPT- "what's a tidyverse function that makes everything uppercase" and got toupper()**
...
**Answer It's labeling every possible state that could be in an address and then telling R to change that name to the abbreviation within the address.**
...
**Answer It makes sense that the most campaign expenses would becoming from within Maryland since this is for Maryland political parties. Virginia being up there also makes sense because of proximity.**
...
1.  What expenditure is the most expensive?

2.  What committee spends the most?

3.  What city has the most expenses?
