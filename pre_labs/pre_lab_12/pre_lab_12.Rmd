...
**Task** Run the following code and describe the dataframe it outputs. **Answer They are press releases**
...
**Task** Run the following code and describe what the `unique` function does to the original list of words. **Answer It lists everytime it was said**
...
**Task** Run the following code and describe the output of using the `unnest_tokens` function. **Answer It lists every time a word was said and in what press release**
...
**Task** Run the following code and describe the results. Is it more interesting than before? **Answer Yes because now it says the amount and percent**
...
**Task** Run the following code and describe the results. **Answer Covid 19 was the most common phrase in 2021**
...
**Task** Run the following code and describe the results. **Answer Project location was the most common phrase**
...
**Task** Run the following code and describe the results. **Answer Human rights is the most common phrase**
...
**Task** Run the following code and describe the results. Do any of the sentiments seem incorrect or counter-intuitive? **Answer It says Trump is positive lol**
