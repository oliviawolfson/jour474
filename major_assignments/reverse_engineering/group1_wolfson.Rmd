...
-   **Analysis summary**: [Write up two to three sentences describing the results of your analysis. Were you able to confirm the finding? If not, why not?]
    -   When you filter for just Baltimore and 2014 and "Closed by arrest" you get for .407 which is roughly 41%.
...
-   **Analysis summary**: We found the correct answer by looking at each year since 2015 to when the article was published, and then filtering which of these were closed by arrest which was 252. We also got 25% were closed by arrest, which is 1 out of 4.
