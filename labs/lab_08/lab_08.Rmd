...
**A1. Yes PG has more calls in December than Baltimore and Baltimore has more calls in August.**
...
**A2. There's a mid year spike in the data in the middle of the year then a drop at the end.**
...
**A3. There is a slight correlation between having a lower median income in an area and a higher number of overdose calls. I would then look into the resources each of these areas has to deal with drug problems.**
...
pg_calls_with_income <- pg_calls_zipcodes |> inner_join (md_median_income_zip, by = c('zipcode'='GEOID'))
 ...
 ggplot() + geom_point(aes(x=estimate, y=total_calls)) 
